...
export function RSVPForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white border-4 border-black p-8 md:p-12" style={{ boxShadow: '8px 8px 0 0 #000' }}>
      ...
      <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <label className="flex-1 cursor-pointer">
              ...
              <div
                ...
                style={formData.attendance_status === 'attending' ? { boxShadow: '4px 4px 0 0 #000' } : {}}
              >
            ...
            <label className="flex-1 cursor-pointer">
              ...
              <div
                ...
                style={formData.attendance_status === 'not_attending' ? { color: '#22C55E', boxShadow: '4px 4px 0 0 #000' } : {}}
              >
        ...
        <div className="bg-gray-50 border-4 border-black p-6" style={{ boxShadow: '4px 4px 0 0 #000' }}>
          <div className="text-center mb-4">
            <a
              ...
              style={{ boxShadow: '6px 6px 0 0 #000', fontSize: '16px' }}
            >
              プライバシーポリシー
            </a>
          </div>
